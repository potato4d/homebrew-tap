...
class TranslateCli < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/potato4d/homebrew-tap/releases/download/translate-cli-v0.1.0/t-darwin-amd64.tar.gz"
      sha256 "541fa4234c816dcc2b4451561a19dc68705829a4e2d32df2d102b8b47d7d1226"
    end
    if Hardware::CPU.arm?
      url "https://github.com/potato4d/homebrew-tap/releases/download/translate-cli-v0.1.0/t-darwin-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/potato4d/homebrew-tap/releases/download/translate-cli-v0.1.0/t-linux-amd64.tar.gz"
      sha256 "c498de381bddfa4ba11e0c5ef45982d495f6a3e1c1a82993f7b0f694b9792bcd"
    end
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/potato4d/homebrew-tap/releases/download/translate-cli-v0.1.0/t-linux-arm64.tar.gz"
